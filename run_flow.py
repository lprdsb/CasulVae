...
if not os.path.exists('./figs_vae_f/'):
	os.makedirs('./figs_vae_f/')
...
m = len(train_dataset)
save_image(test_u[0], 'figs_vae_f/reconstructed_image_true.png', value_range = (0,1))
for epoch in range(args.epoch_max):
	...
	if epoch % 10 == 0:
		with torch.no_grad():
			...
			save_image(reconstructed_image[0], 'figs_vae_f/reconstructed_image_{}.png'.format(epoch), value_range = (0,1))
